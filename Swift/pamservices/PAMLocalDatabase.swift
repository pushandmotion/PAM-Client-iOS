...
class PAMLocalDataBase {
    ...
    class func getInstance() -> PAMLocalDataBase {
        ...
        lockQueue.sync {
            if sharedInstance == nil {
                sharedInstance = PAMLocalDataBase()
            }
        }
    ...
    func getMtcID() -> String {
        let defaults = UserDefaults.standard
        return defaults.object(forKey: "mtc_id")! as! String
    }
    
    func getSID() -> String {
        let defaults = UserDefaults.standard
        return defaults.object(forKey: "sid")! as! String 
    }
    
    func getUPDFH() -> String {
        let defaults = UserDefaults.standard
        return defaults.object(forKey: "updfh")! as! String
    }
}
